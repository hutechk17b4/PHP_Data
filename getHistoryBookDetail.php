<?php 
	...
	$IDBooking=$_POST['idbookingpost'];//filter_input(INPUT_POST, "IDLichTrinhPost");//"1";//
	

	$query="SELECT IDBooking,IDKhachHang,TimeCreate,IDseat_no,TenPhim,IDLichTrinh FROM booking WHERE IDKhachHang='".$IDKhachHang."' AND IDBooking='".$IDBooking."' ";
